...
**@afc/js-tailwind** is an open-source project, so pull requests are always welcomed (_always_ ❤️).
...
As you can see we have multiple branches:
 - **master**: This branch stores the latest stable version of @afc/js-tailwind.
 - **dev-master**: This is the **development** branch of @afc/js-tailwind, and this is where everything is happening before releasing on master
